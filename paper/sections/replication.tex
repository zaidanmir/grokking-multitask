...
(roughly $\log(p) \approx 4.7$) for thousands of steps; then test loss
drops abruptly. The grok step --- the first step at which test accuracy
exceeds 0.95 --- is reported in Table \ref{tab:grok_steps_single}.
